      ...
      <Box className="relative mb-16 max-w-full lg:w-[800px] mx-auto">
        ...
        <Box className="ml-8 lg:ml-20 space-y-10">
          ...
          {[
            ...
            {
              time: '10:30 – 11:00',
              title: 'Спикер: Жумаматова Гульмира Каимовна',
              description:
                'Директор Школы креативной индустрии МУИТ. Тема: «Генерация идей». Основы поиска инновационных идей и их оценка.',
            },
            {
              time: '11:00 – 11:30',
              title: 'Спикер: Эргешов Султан Эрмекович',
              description:
                'Mentor, Mid-level UI/UX Developer, GEEKS. Тема: «Доступный и инклюзивный дизайн: как сделать продукт удобным для всех»',
            },
            {
              time: '11:30 – 12:00',
              title: 'Спикер: Нурбеков Айдин Нурбекович',
              description:
                'Product Manager, Бакай Банк. Тема: «Работа с данными для улучшения городского пространства»',
            },
      ...
      <Box className="relative mb-16 pt-9 max-w-full lg:w-[800px] mx-auto">
        ...
        <Box className="ml-8 lg:ml-20 space-y-10">
          ...
          {[
            ...
            {
              time: '10:00 – 10:30',
              title: 'Спикер: Зархин Евгений Юрьевич',
              description:
                'Технический специалист, ЦАИТО МУИТ. Тема: «Передовые технологии для образовательного процесса»',
            },
            {
              time: '10:30 – 11:00',
              title: 'Спикер: Шабельник Данил Петрович',
              description:
                'Middle Backend Developer, выпускник КОМТЕХНО. Тема: «Как быстро вести IT-разработку на хакатонах»',
            },
            {
              time: '11:00 – 11:30',
              title: 'Спикер: Сартов Ахмед Исмазович',
              description:
                'Middle Frontend Developer, выпускник КОМТЕХНО. Тема: «10 советов для успешной презентации»',
            },
